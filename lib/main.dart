...
import 'screen/opening_apps/login_or_signup/chose_login_or_signup.dart';
import 'screen/opening_apps/on_boarding/on_boarding.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    EasyLocalizationProvider.of(context).data.changeLocale(Locale('es', 'MX'));
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return EasyLocalizationProvider(
      data: data,
      child: Scaffold(
        backgroundColor: ZooluColors.SecondaryColor,
        body: Container(
                ...
                child: Container(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      /// Animation text Zoolu to choose Login with Hero Animation (Click to open code)
                      // Hero(
                      //   tag: "Zoolu",
                      //   child: Text(
                      ...
                      Image.asset('assets/img/logo-zoolu.png', height: 100,),
                    ],
                  ),
                ),
              ),
