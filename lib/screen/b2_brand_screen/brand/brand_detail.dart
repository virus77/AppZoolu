...
// import 'brand_chat.dart';

class BrandDetail extends StatefulWidget {
  /// Get data from brand.dart (List Item)
  /// Declare class
  final Brand brand;
                              ...
                              child: ListView(
                                ...
                                children: <Widget>[
                                  ...
                                  InkWell(
                                      ...
                                      child: Image.asset(
                                          "assets/imgPromo/Discount1.png")),
                                  Padding(padding: EdgeInsets.only(left: 10.0)),
                                  InkWell(
                                      onTap: onClickWeekPromotion,
                                      child: Image.asset(
                                          "assets/imgPromo/Discount3.png")),
                                  Padding(padding: EdgeInsets.only(left: 10.0)),
                                  InkWell(
                                      onTap: onClickWeekPromotion,
                                      child: Image.asset(
                                          "assets/imgPromo/Discount2.png")),
                                  Padding(padding: EdgeInsets.only(left: 10.0)),
                                  InkWell(
                                      onTap: onClickWeekPromotion,
                                      child: Image.asset(
                                          "assets/imgPromo/Discount4.png")),
                                  Padding(padding: EdgeInsets.only(left: 10.0)),
                                  InkWell(
                                      onTap: onClickWeekPromotion,
                                      child: Image.asset(
                                          "assets/imgPromo/Discount5.png")),
                                  Padding(padding: EdgeInsets.only(left: 10.0)),
                                  InkWell(
                                      onTap: onClickWeekPromotion,
                                      child: Image.asset(
                                          "assets/imgPromo/Discount6.png")),
                                ],
                              ),
                            ),
                          ],
        ...
        Row(
          ...
          children: <Widget>[
            ...
            IconButton(
              ...
              tooltip: AppLocalizations.of(context).tr('cart'),
              onPressed: () {
                Navigator.of(context).push(
                    PageRouteBuilder(pageBuilder: (_, __, ___) => new B3CartScreen()));
              },
            ),
          ],
        ),
