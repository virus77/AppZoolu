...
import 'package:treva_shop_flutter/screen/opening_apps/on_boarding/on_boarding_login.dart';
import 'package:treva_shop_flutter/screen/opening_apps/on_boarding/on_boarding.dart';
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Center(
                                      ...
                                      child: Image.asset(
                                    'assets/img/logo-zoolu-vertical.png',
                                    height: 150,
                                  )),
                                  ...
                                  Padding(
                                    padding:
                                        EdgeInsets.fromLTRB(50, 60, 50, 200),
                                    child: RichText(
    ...
    widget.animationController.addListener(() {
      if (widget.animation.isCompleted) {
        Navigator.of(context).pushReplacement(MaterialPageRoute(
            builder: (BuildContext context) => new OnBoardingLogin()));
      }
    });
...
class _AnimationSplashSignupState extends State<AnimationSplashSignup> {
  ...
  Widget build(BuildContext context) {
    widget.animationController.addListener(() {
      if (widget.animation.isCompleted) {
        Navigator.of(context).pushReplacement(MaterialPageRoute(
            builder: (BuildContext context) => new OnBoarding()));
      }
    });
    return AnimatedBuilder(
      animation: widget.animationController,
