...
import 'package:treva_shop_flutter/model/grid_item.dart';
import 'package:treva_shop_flutter/screen/b1_home_screen/b1_home/b1_scanner.dart';
import 'package:treva_shop_flutter/screen/b1_home_screen/g500/g500_branches.dart';
import 'package:treva_shop_flutter/screen/b1_home_screen/home_ui_component/app_bar_component/app_bar_gradient.dart';
import 'package:treva_shop_flutter/screen/b1_home_screen/home_ui_component/detail_product_screen/category_detail.dart';
import 'package:treva_shop_flutter/screen/b1_home_screen/home_ui_component/detail_product_screen/detail_product.dart';
import 'package:treva_shop_flutter/screen/b1_home_screen/home_ui_component/detail_product_screen/menu_detail.dart';
import 'package:treva_shop_flutter/screen/b1_home_screen/home_ui_component/detail_product_screen/promotion_detail.dart';
import 'package:treva_shop_flutter/screen/b1_home_screen/home_ui_component/flash_sale/flash_sale.dart';
import 'package:treva_shop_flutter/screen/b4_profile_screen/account_ui_component/credit_card_setting.dart';

class B1HomeScreen extends StatefulWidget {
  @override
  _B1HomeScreenState createState() => _B1HomeScreenState();
}

/// Component all widget in home
class _B1HomeScreenState extends State<B1HomeScreen>
  ...
  Widget build(BuildContext context) {
    ...
    /// Navigation to menu_detail.dart if user Click icon in category Menu like a example camera
    var onClickMenuIcon = () {
              ...
              children: [
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Image.asset('assets/img/logo-zoolu.png', height: 60,),
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        ...
                        //     pageBuilder: (_, __, ___) => B1Scanner()));
                      },
                    ),
                      ...
                      FlatButton(
                        ...
                        onPressed: () async {
                          LocationResult result = await showLocationPicker(
                            context,
                            'AIzaSyD5xzgc4V5O2aEpUbQzB4cN3_Y2hFImBoU',
...
//                      resultCardAlignment: Alignment.bottomCenter,
                    ...
                    FloatingActionButton.extended(
                      ...
                      backgroundColor: Color(0xFF057C88),
                      label: Text('Movimientos y tarjetas'),
