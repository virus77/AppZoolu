...
class CreditCardCustomForm extends StatefulWidget {
  const CreditCardCustomForm({
    Key key,
    this.cardNumber,
    this.expiryDate,
    this.cardHolderName,
  ...
  @override
  _CreditCardCustomFormState createState() => _CreditCardCustomFormState();
}

class _CreditCardCustomFormState extends State<CreditCardCustomForm> {
  String cardNumber;
  String expiryDate;
  ...
  void initState() {
    ...
    _cardHolderNameController.text = this.cardHolderName;
    _cardNumberController.text = this.cardNumber;
    _cvvCodeController.text = this.cvvCode;
    _expiryDateController.text = this.expiryDate;
  }
