...
class EditCreditCard extends StatefulWidget{
  ...
  EditCreditCard({this.model});

  @override
  _EditCreditCard createState() => _EditCreditCard(model: this.model);
}

class _EditCreditCard extends State<EditCreditCard>{
  final CreditCardCustomModel model;

  _EditCreditCard({this.model});
  ...
  //   if (!mounted) return;
  //   setState(() {
  //     model.cardNumber = cardDetails.cardNumber;
  //     model.cardExp = cardDetails.expiryDate;
  //     model.cardName = cardDetails.cardHolderName;
  //   });
  // }
